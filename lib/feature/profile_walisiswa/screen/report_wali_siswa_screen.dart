...
import '../../home/bloc/bloc/report_bulanan_bloc.dart';

class ReportWaliSiswaScreen extends StatefulWidget {
  const ReportWaliSiswaScreen({super.key});

  @override
  State<ReportWaliSiswaScreen> createState() => _ReportWaliSiswaScreenState();
}

class _ReportWaliSiswaScreenState extends State<ReportWaliSiswaScreen> {
              ...
              children: [
                BlocConsumer<ReportBulananBloc, ReportBulananState>(
                  ...
                  builder: (context, state) {
                    ...
                    } else if (state is ReportBulananError) {
