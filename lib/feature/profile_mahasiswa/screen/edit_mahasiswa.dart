...
class EditMahasiswaPage extends StatefulWidget {
  const EditMahasiswaPage({super.key});

  @override
  State<EditMahasiswaPage> createState() => _EditMahasiswaPageState();
}

Future<Response<dynamic>?> updateMahasiswa(
    String? nameInpt, String? fakultasInpt, String? prodiInpt) async {
  try {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () async {
                  var res = await updateMahasiswa(
                      nameMahasiswaController.text,
                      prodiMahasiswaController.text,
                      fakultasMahasiswaController.text);
        ...
        body: ListView(
          ...
          children: [
            ...
            SizedBox(
              ...
              height: 30,
              child: TextFormField(
                controller: nameMahasiswaController
                  ..text = "", //widget.mahasiswa.data!.namaMahasiswa!,
            ...
            SizedBox(
              ...
              height: 30,
              child: TextFormField(
                controller: prodiMahasiswaController
                  ..text = "", // widget.mahasiswa.data!.prodi!,
                decoration: const InputDecoration(),
              ),
            ),
            const SizedBox(
            ...
            SizedBox(
              ...
              height: 30,
              child: TextFormField(
                controller: fakultasMahasiswaController
                  ..text = "", // widget.mahasiswa.data!.prodi!,
                decoration: const InputDecoration(),
              ),
            ),
